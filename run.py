...
def store_state(i, pheromones, colony_positions, food_positions, ant_positions, ant_foods):
...
def init_figure(pheromones, colony_positions, food_positions, ant_positions, ant_foods):
    fig = plt.figure()
...
def compute_then_plot(env, steps):
    ...
    for i in range(1, steps + 1):
        ...
        store_state(i, pheromones, colony_positions, food_positions, ant_positions, ant_foods)
...
def plot_continuous(env, steps = 1000):
    ...
    for i in range(steps):
        ...
        # store the state for animation
        store_state(i + 1, pheromones, colony_positions, food_positions, ant_positions, ant_foods)
